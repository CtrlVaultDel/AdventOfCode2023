...
fn calc_power(game: &Game) -> i32{
    return game.max_red * game.max_green * game.max_blue;
}

fn _game_possible(solution: &Game, game: &Game) -> i32{
...
mod tests {
    ...
    fn test_six(){
        ...
        for game in games{
            id_sum += _game_possible(&solution, &game);
        }
